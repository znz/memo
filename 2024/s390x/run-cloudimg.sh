...
base=ubuntu-22.04-server-cloudimg-s390x.img
if [ ! -f "$base" ]; then
...
bios=$(echo /opt/homebrew/Cellar/qemu/*/share/qemu/s390-ccw.img)
...
args=(
    ...
    -smp 4
    -bios "$bios"
    -device "virtio-net-ccw,netdev=net0" -netdev "user,id=net0,hostfwd=tcp::2222-:22"
